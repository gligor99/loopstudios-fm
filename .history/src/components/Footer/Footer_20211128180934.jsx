    ...
    <div className="footer-container">
      ...
      <div className="right-content">
        <div className="social">
          ...
          <img className='social-icon' src={instagram} alt="instaIcon.svg" />
          <img className='social-icon'  src={pinterest} alt="pinterestIcon.svg" />
          <img className='social-icon' src={twittter} alt="twitterIcon.svg" />
        </div>
        <p className="copy">
          &copy;
